%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Figures 4.59 & 60
% Beampatter for 91-element array with radial taper squared weighting, R = 2.75*lambda
% Xiaomin Lu 11-2-98
% Updated by K. Bell 10/11/00
% Updated by Lillian Xu 12/06/2000, K. Bell 9/30/01
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%title('Response of 91-ele Hex array, with 2nd Radial Taper Wght, R=2.75\lambda')
figure
