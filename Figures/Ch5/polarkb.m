function hpol = polarkb(theta,rho,line_style)
% Polarkb plots using different axes than regular polar
% range is 0 to 360 with zero at top, and counterclockwise
% K. Bell 7/24/01
