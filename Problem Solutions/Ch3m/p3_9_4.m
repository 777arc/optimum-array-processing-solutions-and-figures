...
hold off
DI = -10*log10(abs(w'*w));
title(['Problem 3.9.4, N= ' int2str(N) ', SL = ' num2str(SLLdb) ', DI = ' num2str(DI) ', iter. = ' int2str(it)])
...
xlabel('u')
ylabel('Beampattern (dB)')
title(['Problem 3.9.4, N= ' int2str(N) ', SL = ' num2str(SLLdb) ', iter. = ' int2str(it)])
